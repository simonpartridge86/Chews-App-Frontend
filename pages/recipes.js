...
function Recipes() {
  ...
  return(<div className="flex flex-col justify-around items-center">
  <br></br>
  <Link>Back to results <ArrowBackIcon/></Link>
  <br></br>
  <h2 className="text-primary-color font-permanent-marker text-2xl">You are making:</h2>
  <br></br>
  <h3 className="text-dark-color font-nunito text-lg">{recipeData[0].recipe.label}</h3>
  <br></br>
  <img
   ...
   {recipeData[0].recipe.ingredientLines.map((ingredient) => {
    return(<li className="text-dark-color font-nunito">
  ...
  <br></br>
  <p className="w-4/5 text-dark-color font-nunito">Preheat the oven to fan 200C/ conventional 220C/gas 7. Put the onion, courgettes, pepper and tomatoes in a shallow roasting tin and season with black pepper.
